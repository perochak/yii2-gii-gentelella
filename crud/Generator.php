...
class Generator extends \yii\gii\Generator
{
    ...
    public $baseReplaceString = 'Model';
    ...
    /**
     * @author   Igor Chepurnoy
     * Replace special character in model class
     * @internal param $search
     * @return string
     */
    public function getModelNameForView(){
        $modelClass = str_replace($this->baseReplaceString,'',$this->modelClass);
